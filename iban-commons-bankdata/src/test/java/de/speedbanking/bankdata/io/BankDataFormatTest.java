...
final class BankDataFormatTest {
    ...
    @Test
    void read_emptyBankCode_throwsIOException() {
        String content = BankDataFormat.HEADER_LINE + "\n"
            + ";;MARKDEF1100;Bundesbank;10117;Berlin;\n";

        assertThatThrownBy(() -> BankDataFormat.read(
            new ByteArrayInputStream(content.getBytes(UTF_8)), UTF_8, "DE", "v1"))
    ...
    @Test
    void read_emptyBankName_throwsIOException() {
        String content = BankDataFormat.HEADER_LINE + "\n"
            + "10000000;;MARKDEF1100;;10117;Berlin;\n";
