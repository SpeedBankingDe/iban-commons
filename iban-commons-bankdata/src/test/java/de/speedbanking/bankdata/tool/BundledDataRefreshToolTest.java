...
final class BundledDataRefreshToolTest {
    ...
    @Test
    void resolveCountryCodes_explicitCh_isStillResolved() {
        Set<String> countryCodes = BundledDataRefreshTool.resolveCountryCodes(new String[] {"CH"});

        assertThat(countryCodes).containsExactly("CH");
    }

    @Test
    void allowsBundledSnapshot_ch_returnsFalse() {
        assertThat(BundledDataRefreshTool.allowsBundledSnapshot("CH")).isFalse();
    }

    @Test
    void allowsBundledSnapshot_de_returnsTrue() {
        assertThat(BundledDataRefreshTool.allowsBundledSnapshot("DE")).isTrue();
    }

    @Test
    void allowsBundledSnapshot_unknownCode_throwsIllegalStateException() {
        assertThatThrownBy(() -> BundledDataRefreshTool.allowsBundledSnapshot("XX"))
