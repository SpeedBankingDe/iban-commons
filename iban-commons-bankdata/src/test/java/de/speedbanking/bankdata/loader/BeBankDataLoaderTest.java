...
/**
 * Unit tests for {@link BeBankDataLoader}, run against a minimal XLSX package built at test time
...
final class BeBankDataLoaderTest {

    private final BeBankDataLoader loader = new BeBankDataLoader();
    ...
    void parse_sampleXlsx_skipsTitleAndHeaderRows_prefersEnglishName_stripsBicSpaces_andHandlesUnassignedCode() throws Exception {
        ...
        assertThat(records).extracting(BankData::getBankCode).containsExactly("001", "068", "171", "999");
        ...
        assertThat((Object) first.getPostalCode()).isNull();
        assertThat((Object) first.getCity()).isNull();
