...
/**
 * Unit tests for {@link BankDataLoaderCh}.
 */
@SuppressWarnings("checkstyle:MethodName")
final class BankDataLoaderChTest {

    private final BankDataLoaderCh loader = new BankDataLoaderCh();
    ...
    void remoteSourceUri_returnsDefaultSourceUri() {
        assertThat(loader.getRemoteSourceUri()).isEqualTo(BankDataLoaderCh.DEFAULT_SOURCE_URI);
    }
    ...
    @Test
    void allowsBundledSnapshot_returnsFalse() {
        assertThat(loader.allowsBundledSnapshot()).isFalse();
    }
    ...
    void parse_sampleFile_skipsHeaderConcatenatedAndBiclessRows_padsIidAndPopulatesPostalCodeAndCity() throws Exception {
        ...
        assertThat(records).extracting(BankData::getBankCode)
            .containsExactlyInAnyOrder("00700", "00760", "00781");
