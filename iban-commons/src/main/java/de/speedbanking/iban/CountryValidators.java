 ...
 * The inner classes are produced by a code generator and must not be edited by hand.
 * The region between the {@code BGN} and {@code END} markers below is overwritten
...
final class CountryValidators {
    ...
    /** Validator for Cabo Verde (CV), IBAN length: 25, BBAN pattern: {@code 4!n4!n13!c} */
    ...
    /** Validator for Czechia (CZ), IBAN length: 24, BBAN pattern: {@code 4!n6!n10!n} */
    ...
    /** NCD-aware Validator for Djibouti (DJ), IBAN length: 27, BBAN pattern: {@code 5!n5!n11!n2!n} */
    static final class DJ extends AbstractNcdCountryValidator {
        @Override
        public boolean validateIban(final char[] iban) {
            return isAllDigits(iban, 4, 27)
                && validateNationalCheckDigit(iban);
    ...
    /** Validator for Algeria (DZ), IBAN length: 24, BBAN pattern: {@code 3!n5!n10!n2!n} */
    static final class DZ extends AbstractCountryValidator {
        @Override
        public boolean validateIban(final char[] iban) {
            return isAllDigits(iban, 4, 24);
        }
    ...
    /** Validator for Falkland Islands (Malvinas) (FK), IBAN length: 18, BBAN pattern: {@code 2!a12!n} */
    ...
    /** Validator for United Kingdom of Great Britain and Northern Ireland (GB), IBAN length: 22, BBAN pattern: {@code 4!a6!n8!n} */
    ...
    /** Validator for Iran (Islamic Republic of) (IR), IBAN length: 26, BBAN pattern: {@code 3!n19!n} */
    ...
    /** Validator for Moldova, Republic of (MD), IBAN length: 24, BBAN pattern: {@code 2!c18!c} */
    ...
    static final class PL extends AbstractCountryValidator {
        @Override
        public boolean validateIban(final char[] iban) {
            return isAllDigits(iban, 4, 28);
        }
    ...
    /** Validator for Palestine, State of (PS), IBAN length: 29, BBAN pattern: {@code 4!a21!c} */
    ...
    /** Validator for Russian Federation (RU), IBAN length: 33, BBAN pattern: {@code 9!n5!n15!c} */
    ...
    /** NCD-aware Validator for Sweden (SE), IBAN length: 24, BBAN pattern: {@code 3!n16!n1!n} */
    static final class SE extends AbstractNcdCountryValidator {
        @Override
        public boolean validateIban(final char[] iban) {
            return isAllDigits(iban, 4, 24)
                && validateNationalCheckDigit(iban);
    ...
    /** Validator for São Tomé and Príncipe (ST), IBAN length: 25, BBAN pattern: {@code 4!n4!n11!n2!n} */
    ...
    /** NCD-aware Validator for Türkiye (TR), IBAN length: 26, BBAN pattern: {@code 5!n1!n16!c} */
    ...
    /** Validator for Holy See (VA), IBAN length: 22, BBAN pattern: {@code 3!n15!n} */
    ...
    /** Validator for Virgin Islands (British) (VG), IBAN length: 24, BBAN pattern: {@code 4!a16!n} */
